...
4. **Adding Escalation Levels:**
    ...
    ![Add Esclation](../images/add-esclations.png)
    - You will see three drop-down options:
    ![Escalation Levels](../images/assign-bots.png)
...
5. **Configuring Escalation Timing:**
    ...
    [Escalation Timing](../images/Escalation-Timing.png)
...
![Accessing Policies](../images/policy.png)
...
![Expand-policy](../images/Expand-policy.png)
s
#### Managing Policies:    
