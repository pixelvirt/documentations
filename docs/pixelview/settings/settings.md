...
* Paste your standard `clouds.yaml` content into the code editor.
...
* Click **SAVE** to test and persist the cloud connection.
...
* In the **Kubernetes** tab, click the **`+`** (Add) button on the table toolbar.
...
* Fill in the cluster parameters:
...
* Click **SAVE** to register the cluster.
...
* Enter or paste your **License Key** into the text area.
* Enter the **Application Password**.
* Click **APPLY LICENSE** to validate and activate your PixelView instance.
